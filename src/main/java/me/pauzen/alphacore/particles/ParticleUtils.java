...
public final class ParticleUtils {
     ...
     */
    public static void spawnParticle(Particle particle, Location location, Vector velocity, double speed, int amount) {
    ...
    public static void spawnParticle(Particle particle, World world, Location location, Vector velocity, int speed, int amount) {
        if (!world.getPlayers().isEmpty()) {
            ParticleUtils.spawnParticle(particle, location, velocity, speed, amount);
        }
    }
